...
router.get("/dashboard", isAuthenticated, (req, res) => {
    res.render('layout', { user: req.user, page: 'patient_dashboard' });
});
...
router.get("/appointments", isAuthenticated, async (req, res) => {
    try {
        ...
        res.render('layout', { user: req.user, page: 'patient_appointments', appointments, pastAppointments });
    } catch (error) {
...
router.get("/account", isAuthenticated, (req, res) => {
    res.render('layout', { user: req.user, page: 'patient_account' });
});
